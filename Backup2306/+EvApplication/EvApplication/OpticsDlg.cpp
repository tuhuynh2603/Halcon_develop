...
void COpticsDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Radio(pDX, IDC_RADIO_FOV1, m_nFOVSetting);
...
BEGIN_MESSAGE_MAP(COpticsDlg, CDialogBar)
	...
	ON_BN_CLICKED(IDC_RADIO_FOV1, &COpticsDlg::OnBnClickedCheckFOVSetting)
	ON_BN_CLICKED(IDC_RADIO_FOV2, &COpticsDlg::OnBnClickedCheckFOVSetting)
	ON_BN_CLICKED(IDC_RADIO_FOV3, &COpticsDlg::OnBnClickedCheckFOVSetting)
	ON_BN_CLICKED(IDC_RADIO_FOV4, &COpticsDlg::OnBnClickedCheckFOVSetting)
	ON_BN_CLICKED(IDC_RADIO_FOV5, &COpticsDlg::OnBnClickedCheckFOVSetting)
END_MESSAGE_MAP()
...
HBRUSH COpticsDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
	...
	if (pWnd->GetDlgCtrlID() == IDC_RADIO_FOV1 || pWnd->GetDlgCtrlID() == IDC_RADIO_FOV2 ||
		pWnd->GetDlgCtrlID() == IDC_RADIO_FOV3 || pWnd->GetDlgCtrlID() == IDC_RADIO_FOV4 ||
		pWnd->GetDlgCtrlID() == IDC_RADIO_FOV5)
	{
		// Set color as red.
		pDC->SetTextColor(RGB(68, 174, 255));
		pDC->SetBkMode(TRANSPARENT);
	...
	if (pWnd->GetDlgCtrlID() == IDC_STATIC_FOV_MODE ){
		// Set color as red.
		pDC->SetTextColor(RGB(68, 174, 255));
		pDC->SetBkMode(TRANSPARENT);
	}
...
void COpticsDlg::OnBnClickedCheckFOVSetting()
{
	UpdateData();
}