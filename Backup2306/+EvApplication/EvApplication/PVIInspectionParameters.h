...
public:
	...
	CCopyPVIInspectionDlg* m_pCopyPVIParamDlg;
...
public:
	...
	CStringArray strArrayPviAreaType;
	CStringArray strArrayDefectSel;
	CStringArray strArrayDirectionFilter;
...
//	CString m_strNoOfPviArea;
	...
	void CleanPviParms();
	afx_msg void OnBnClickedButtonCopyPviParam();
	afx_msg void OnBnClickedButtonCopyPviParamFov();
	afx_msg void OnBnClickedButtonCopyDefectCharacteristic();
};
