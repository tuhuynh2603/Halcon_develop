...
class CCalibrationSettings : public CDialogEx
{
...
public:
	...
	void GoToCalibration(int nCalbGreyValue,int nDoc,BOOL bDotCalibration);
	...
	afx_msg void OnBnClickedButtonDistanceCalibration();
	afx_msg void OnBnClickedRadioTopStation();
	afx_msg void OnBnClickedRadioThrCamera();
	afx_msg void OnBnClickedButtonJigLeveling();
	afx_msg void OnBnClickedButtonTeachZSensorPos();
};
