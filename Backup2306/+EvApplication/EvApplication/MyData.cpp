...
void CMyData::ResetDefaults()
{
	...
	m_nSaveOnlineBMPImages			= 0;
	m_nVerificationMode				= 0;
	m_nVerificationWindow			= 0;


	m_nSequenceRun					 =0;
	m_nNestReplaceMent				 =0;
	m_nBarCode						 =0;
	m_nClamp						 =0;
	m_nUnClamp						 =0;
	m_nScanningOptions				 =0;
...
CMyStaticPropertyItemManger::CMyStaticPropertyItemManger()
{
	...
	//	PROPERTY_ITEM(ID_PD_ONLINE_BYPASSRESULT, CPropertyItemListAccessLevel, _T("ByPass Result"), true)
		...
		PROPERTY_ITEM(ID_PD_ONLINE_VERIFICATIONMODE, CPropertyItemListAccessLevel, _T("Verfication Mode"), true)
		PROPERTY_ITEM(ID_PD_ONLINE_VERIFICATIONWINDOW, CPropertyItemListAccessLevel, _T("Verificatin Window"), true)
	...
	BEGIN_PROPERTY_TAB(_T("Inspection"), true)
		...
		PROPERTY_ITEM(ID_PD_INSPECTION_INSPSAVEIMG, CPropertyItemListAccessLevel, _T("Auto Run"), true)
	...
	BEGIN_PROPERTY_TAB(_T("Tools"), true)
		...
		PROPERTY_ITEM(ID_PD_TOOLS_MOTOR_TRIGGER, CPropertyItemListAccessLevel, _T("Motor Trigger"), true)
		...
		PROPERTY_ITEM(ID_PD_TOOLS_TRIANGULAR_SENSOR, CPropertyItemListAccessLevel, _T("Triangular Sensor"), true)
		PROPERTY_ITEM(ID_PD_TOOLS_BARCODE_READER, CPropertyItemListAccessLevel, _T("Barcode Reader"), true)
	...
	BEGIN_PROPERTY_TAB(_T("Sequence"), true)
			PROPERTY_ITEM(ID_PD_SEQUENCE_RUN, CPropertyItemListAccessLevel, _T("Sequence Run"), true)
			PROPERTY_ITEM(ID_PD_SEQUENCE_NESTREPLACEMENT, CPropertyItemListAccessLevel, _T("Nest Replacement"), true)
			PROPERTY_ITEM(ID_PD_SEQUENCE_BARCODE, CPropertyItemListAccessLevel, _T("BarCode"), true)
			PROPERTY_ITEM(ID_PD_SEQUENCE_CLAMP, CPropertyItemListAccessLevel, _T("Clamp"), true)
			PROPERTY_ITEM(ID_PD_SEQUENCE_UNCLAMP, CPropertyItemListAccessLevel, _T("UnClamp"), true)
			PROPERTY_ITEM(ID_PD_SEQUENCE_OPTIONS, CPropertyItemListAccessLevel, _T("Sequence Option"), true)
...
void CMyStaticPropertyItemManger::SetData(const CMyData& data)
{
	BEGIN_ITERATE_PROPERTY_ITEMS()
		...
		SET_ITEM_LIST(ID_PD_ONLINE_VERIFICATIONMODE, data.m_nVerificationMode)
		SET_ITEM_LIST(ID_PD_ONLINE_VERIFICATIONWINDOW, data.m_nVerificationWindow)
		...
		SET_ITEM_LIST(ID_PD_PARM_PVIDEFECT, data.m_nPviDefectParm)
		...
		SET_ITEM_LIST(ID_PD_TOOLS_MOTOR_TRIGGER		,data.m_nMotorTrigger)
		SET_ITEM_LIST(ID_PD_TOOLS_TRIANGULAR_SENSOR	, data.m_nTriangularSensor)
		SET_ITEM_LIST(ID_PD_TOOLS_BARCODE_READER	, data.m_nBarcodeReader)
		...
		SET_ITEM_LIST(ID_PD_SEQUENCE_RUN, data.m_nSequenceRun)
		SET_ITEM_LIST(ID_PD_SEQUENCE_NESTREPLACEMENT, data.m_nNestReplaceMent)
		SET_ITEM_LIST(ID_PD_SEQUENCE_BARCODE, data.m_nBarCode)
		SET_ITEM_LIST(ID_PD_SEQUENCE_CLAMP, data.m_nClamp)
		SET_ITEM_LIST(ID_PD_SEQUENCE_UNCLAMP, data.m_nUnClamp)
		SET_ITEM_LIST(ID_PD_SEQUENCE_OPTIONS, data.m_nScanningOptions)
...
void CMyStaticPropertyItemManger::GetData(CMyData& data) const
{
	BEGIN_ITERATE_PROPERTY_ITEMS()
		...
		GET_ITEM_LIST(ID_PD_ONLINE_VERIFICATIONMODE, data.m_nVerificationMode)
		GET_ITEM_LIST(ID_PD_ONLINE_VERIFICATIONWINDOW, data.m_nVerificationWindow)
		...
		GET_ITEM_LIST(ID_PD_TOOLS_MOTOR_TRIGGER, data.m_nMotorTrigger)
		GET_ITEM_LIST(ID_PD_TOOLS_TRIANGULAR_SENSOR, data.m_nTriangularSensor)
		GET_ITEM_LIST(ID_PD_TOOLS_BARCODE_READER, data.m_nBarcodeReader)
		...
		GET_ITEM_LIST(ID_PD_SEQUENCE_RUN, data.m_nSequenceRun)
		GET_ITEM_LIST(ID_PD_SEQUENCE_NESTREPLACEMENT, data.m_nNestReplaceMent)
		GET_ITEM_LIST(ID_PD_SEQUENCE_BARCODE, data.m_nBarCode)
		GET_ITEM_LIST(ID_PD_SEQUENCE_CLAMP, data.m_nClamp)
		GET_ITEM_LIST(ID_PD_SEQUENCE_UNCLAMP, data.m_nUnClamp)
		GET_ITEM_LIST(ID_PD_SEQUENCE_OPTIONS, data.m_nScanningOptions)
