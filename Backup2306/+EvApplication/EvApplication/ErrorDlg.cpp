...
static const UINT_PTR TIMER_CURTAIN_MUTE = 14;
	...
	, m_strTransportErrorMsg(_T("Running"))
{
	...
	FontTitle.CreateFont(40, 0, 0, 0, 560, TRUE, FALSE, FALSE,
		ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS,
...
//	m_ctrlTransportRetryButton.LoadBitmaps(IDB_RETRYBUTTON, IDB_RETRYBUTTON_PRESSED, 0U, IDB_RETRY_DISABLED);
	...
	GetDlgItem(IDC_ERRORDLG_TRANSPORTMSG_LBL)->SetFont(&Font2);
...
void CErrorDlg::OnStnClickedErrordlgTransportmsgLbl()
{
