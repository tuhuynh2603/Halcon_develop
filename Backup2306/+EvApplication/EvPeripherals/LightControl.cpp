...
int CLightControl::LoadLightSetting(int nController, CString strDirectoryName, int nSet, BOOL bLightDlgOpen, BOOL *bTrackSegments)
{
	if(m_pLightVal == NULL)
		return -1;
	...
	strDataFileName.Format("%s\\LightInfo.ltv", strDirectoryName);
...
int CLightControl::LoadLightSettingFOV(int nController, CString strDirectoryName, int nSet, BOOL bLightDlgOpen, BOOL *bTrackSegments, int nFov)
{
	if (m_pLightVal == NULL)
		return -1;
	...
	strDataFileName.Format("%s\\LightInfo_Fov%d.ltv", strDirectoryName, nFov + 1);
	...
	OutputDebugLogTo(4, TRUE, "[LoadLightSettingFOV] Done");

	return 0;
}

int CLightControl::SaveLightSetting(int nController, CString strDirectoryName, int nSet)
{
	if(m_pLightVal == NULL)
		return -1;
...
int CLightControl::SaveLightSettingFOV(int nController, CString strDirectoryName, int nSet, int nFov)
{
	if (m_pLightVal == NULL)
		return -1;
	...
	SetLightVal(&iniFile, nController, nSet);
	iniFile.WriteFile();
	OutputDebugLogTo(4, TRUE, "[SaveLightSettingFOV] Done");
