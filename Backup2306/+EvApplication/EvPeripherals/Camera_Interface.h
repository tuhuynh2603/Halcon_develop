...
typedef int (CALLBACK* REGISTER_CAMERA)(CString strCameraFile, CString strCardFile, void **pCamModule, BOOL bCreateEvent, BOOL bMonitorMode, BOOL bSetSoftTrigger, BOOL bSetOutputLine);
...
typedef int (CALLBACK* SET_TRIGGER_MODE)(void *pCamModule, int nMode, double m_nCameraTrigDelay);
...
typedef int (CALLBACK* ENABLE_OUTPUT_LINE)(void *pCamModule, bool enable);
...
public :
	...
	ENABLE_OUTPUT_LINE lpEnableOutputLine;
...
int RegisterCamera(CCameraInterface *pFGM, CString strCameraFile, CString strCardFile, BOOL bCreateEvent, BOOL bMonitorMode, BOOL bSetSoftTrigger, BOOL bSetOutputLine);
...
int SetTrigMode(CCameraInterface *pFGM, int nMode, int nTrigDelay);
...
int EnableOutputLine(CCameraInterface *pFGM, bool enable);
