...
public:
	...
	int LoadLightSetting(int nController, CString strDirectoryName, int nSet = 0, BOOL bLightDlgOpen = FALSE, BOOL *bTrackSegments = 0);
	int LoadLightSettingFOV(int nController, CString strDirectoryName, int nSet = 0, BOOL bLightDlgOpen = FALSE, BOOL *bTrackSegments = 0, int nFov = 0);
	int SaveLightSetting(int nController, CString strDirectoryName, int nSet = 0);
	int SaveLightSettingFOV(int nController, CString strDirectoryName, int nSet = 0, int nFov = 0);
