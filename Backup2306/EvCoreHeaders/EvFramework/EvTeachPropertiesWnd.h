...
#define IDC_GRID_PROPERTIES	2010
...
class CTeachPropertiesToolBar : public CMFCToolBar
{
public:
...
class DECLSPEC_WINDOW_IF CEvTeachPropertiesWnd : public CDockablePane
{
// Construction
public:
	CEvTeachPropertiesWnd();
	...
	CPropertyList* m_wndPropLists[40];
// Attributes
public:
...
protected:
	...
	CTeachPropertiesToolBar m_wndToolBar;
	//CPropertyList* m_wndPropLists;
	int m_nPos;
	int m_nSets;
	int m_nTopSets;
