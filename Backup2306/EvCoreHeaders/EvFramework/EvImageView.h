...
protected: // create from serialization only
	...
	// Polygon Dragging Variables
	BOOL m_bEnableCreateDragPolygon;
	BOOL m_bEnablePolygonDragging;
	CPoint m_ptPreCenterDragPolygon;
	int m_nShiftPolygonAlongX;
	int m_nShiftPolygonAlongY;
	void findSmallestRectangle(CRect *rect_DragPolygon);
