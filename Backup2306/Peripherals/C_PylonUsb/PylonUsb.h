...
extern "C" int _stdcall SetTransferParametersThreadPriority(void *pCamModule, int nPriorityValue);
extern "C" int _stdcall GetTransferParametersThreadPriority(void *pCamModule, int *nPriorityValue);
extern "C" int _stdcall SetGrabEngineThreadPriority(void *pCamModule, int nPriorityValue);
extern "C" int _stdcall SetGrabLoopThreadPriority(void *pCamModule, int nPriorityValue);

extern "C" int _stdcall GetStreamMaximumTransferSize(void *pCamModule, int * pdPayloadTransferSize);
extern "C" int _stdcall SetStreamMaximumTransferSize(void *pCamModule, int nPayloadTransferSize);
extern "C" int _stdcall GetStreamMaximumTransferRange(void *pCamModule, int * pdMinPayload, int * pdMaxPayload);

extern "C" int _stdcall SetStreamMaximumBufferSize(void *pCamModule, int bufferSize);
extern "C" int _stdcall GetStreamMaximumBufferSize(void *pCamModule, int *bufferSize);
extern "C" int _stdcall SetStreamMaximumBufferNumber(void *pCamModule, int bufferNumber);
extern "C" int _stdcall GetStreamMaximumBufferRange(void *pCamModule, int * pdMinBufSize, int * pdMaxBufferSize);

extern "C" int _stdcall SetDefaultTransperSizeParameters(void *pCamModule);

extern "C" int _stdcall SetDeviceLinkThroughputLimit(void *pCamModule);
