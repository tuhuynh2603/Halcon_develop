...
{
	I32 nError = APS_field_bus_d_set_output(cardNo, 0, nPortNo, data);	
	if(nError != ERR_NoError) {
...
{
	I32* p32Data = (I32*) pData;
	I32 nError = APS_field_bus_d_get_input(cardNo, 0, nPortNo, p32Data);
	if(nError != ERR_NoError) {
...
{
	I32 nError = APS_set_field_bus_d_channel_output(cardNo, 0, nPortNo, Ch_No, DO_Value);
	if(nError != ERR_NoError) {
...
int _stdcall InPortReadBit(int cardNo, int nPortNo, int Ch_No, UINT *DI_Value)
{
	...
	I32 nError = APS_get_field_bus_d_channel_input(cardNo, 0, nPortNo, Ch_No, p32Data);
	if(nError != ERR_NoError) {
